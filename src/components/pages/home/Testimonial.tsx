...
export const Testimonial = () => {
    return (
        <div className="md:hidden m-auto w-[90%] z-10 -mb-24 animate-slideInDown animate-delay-1000">
            <div className="bg-gray-100 flex items-center gap-6 shadow-md relative transform rotate-1 p-6 pb-8">
                <div className="flex-1 -rotate-1">
                    <div className='m-auto w-48 h-48 bg-gray-200 rounded-full -mt-8 mb-4 overflow-hidden'>
                        <Image
                            src={hero}
                            width="800"
                            height="800"
                    ...
                    <div className='relative'>
                        ...
                        <div className="mt-4 w-fit m-auto">
                            ...
                            <AnimatedButton
                                ...
                                title="Linkedin →"
                                className='bg-gradient-to-r from-[#FD6585] to-[#0D25B9]'
                            />
                        </div>
                    </div>
                </div>
