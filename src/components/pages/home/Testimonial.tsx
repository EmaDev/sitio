...
export const Testimonial = () => {
    return (
        <div className="lg:hidden m-auto pt-12 mb-8 w-[90%] z-10">
            <div className="bg-gray-100 flex items-center gap-6 shadow-md relative transform rotate-1 p-6">
                <div className="flex-1 -rotate-1">
                    <div className='m-auto w-64 h-64 bg-gray-200 rounded-full -mt-10 mb-8 overflow-hidden'>
                        <Image
                            src={hero}
                            width="800"
                            height="800"
                    ...
                    <div className='relative'>
                        ...
                        <div className="mt-4 flex items-center justify-between">
                            <span className="bg-white px-3 py-1 rounded-full border text-sm text-gray-700">
                                @emacisterna
                            </span>
